...
class Komik extends Produk{
    public function getInfoProduk() {
        $str = "Komik : {$this->judul} , {$this->setLabel()} , (Rp. {$this->harga}) - {$this->jmlHalaman} Halaman";
        return $str;
    }
}
...
class Game extends Produk{
    public function getInfoProduk() {
        $str = "Game : {$this->judul} , {$this->setLabel()} , (Rp. {$this->harga}) ~ {$this->waktuMain} Jam";
        return $str;
    }
}
...
$produk2 = new Game("Spiderman", "Savenda", "Sony", 500000, 0, 50);
